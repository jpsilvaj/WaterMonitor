...
public class _SensorNetworkStub extends org.omg.CORBA.portable.ObjectImpl implements sensorNetwork.SensorNetwork
{
  ...
  public void updatePhValueToSensor (sensorNetwork.Sensor sensor, int ph)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                updatePhValueToSensor (sensor, ph        );
            } finally {
                _releaseReply ($in);
            }
  } // updatePhValueToSensor

  public void updateColorValueToSensor (sensorNetwork.Sensor sensor, int color)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("updateColorValueToSensor", true);
                sensorNetwork.SensorHelper.write ($out, sensor);
                $out.write_long (color);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                updateColorValueToSensor (sensor, color        );
            } finally {
                _releaseReply ($in);
            }
